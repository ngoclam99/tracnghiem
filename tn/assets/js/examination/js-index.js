        ...
        success: function (data) {
            ...
            if (data.statusCode == 200) {
                ...
                for (i = 0; i < exams.length; i += 4) {
                    ...
                    <div class="panel-heading text-overflow text-white fw-bold title__panel">${exams[i].title}</div>
                    ...
                    if(i+1<exams.length){
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                        <div class="panel panel-primary exam_item">
                        <div class="panel-heading text-overflow text-white fw-bold title__panel">${exams[i+1].title}</div>
                        <div class="panel-body">
                    ...
                    if(i+2<exams.length){
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                        <div class="panel panel-primary exam_item">
                        <div class="panel-heading text-overflow text-white fw-bold title__panel">${exams[i+2].title}</div>
                        <div class="panel-body">
                    ...
                    if(i+3<exams.length){
                        exam += `<div class="col-xs-24 col-sm-12 col-md-6 col-lg-6">
                        <div class="panel panel-primary exam_item">
                        <div class="panel-heading text-overflow text-white fw-bold title__panel">${exams[i+3].title}</div>
                        <div class="panel-body">
