...
$page = $_GET['act'];
 switch($page){
    case 'list':
    //Get language
    require('language/huongdan/list.php');
...
$link_add ='index.php?module=huongdan&act=add';  
...
if($_SESSION['phan_quyen']=='2'){
    ...
    require('view/template/huongdan/list.tpl');  
    break;
    
    //case them can bo
    case 'add':
    require ('language/huongdan/add.php');
     ...
     $thoi_gian = thoi_gian;
         ...
         $link_list = 'index.php?module=huongdan&act=list';
    ...
    require('view/template/huongdan/add.tpl');
    break;
    //case edit gioi thieu
    case 'edit':
    require('language/huongdan/edit.php');
    $heading_title = heading_title;
    $tieu_de = tieu_de;
    $hinh_anh = hinh_anh;
    $mo_ta = mo_ta;
   ...
   if($_SERVER['REQUEST_METHOD']=='POST')
    ...
    require('view/template/huongdan/edit.tpl');
    break; 
    
    case 'del':
    get_file('language/huongdan/del.php');
    $link_list = 'index.php?module=huongdan&act=list';
