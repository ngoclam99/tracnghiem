...
$page = $_GET['act'];
 switch($page){
    case 'list':
    //Get language
    require('language/thongbao/list.php');
...
$link_add ='index.php?module=thongbao&act=add';  
...
if($_SESSION['phan_quyen']=='2'){
    ...
    require('view/template/thongbao/list.tpl');  
    break;
    
    //case them can bo
    case 'add':
    require ('language/thongbao/add.php');
     ...
     $thoi_gian = thoi_gian;
         ...
         $link_list = 'index.php?module=thongbao&act=list';
    ...
    require('view/template/thongbao/add.tpl');
    break;
    //case edit gioi thieu
    case 'edit':
    require('language/thongbao/edit.php');
    $heading_title = heading_title;
    $tieu_de = tieu_de;
    $hinh_anh = hinh_anh;
    $mo_ta = mo_ta;
   ...
   if($_SERVER['REQUEST_METHOD']=='POST')
    ...
    require('view/template/thongbao/edit.tpl');
    break; 
    
    case 'del':
    get_file('language/thongbao/del.php');
    $link_list = 'index.php?module=thongbao&act=list';
