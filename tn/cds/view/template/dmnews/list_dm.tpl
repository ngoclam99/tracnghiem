...
<?php echo $danhmuc['sap_xep']; ?>
   ...
   <td class="text-center" style="white-space:nowrap; width: 10%;">
                         ...
                         [ <a href="index.php?module=dmnews&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=dmnews&act=del&id=<?=$danhmuc['id']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
