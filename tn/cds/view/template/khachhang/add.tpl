...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       <tr><td><?php echo $ho_ten; ?></td><td><input size="60" type="text" name="ten" value="<?php echo $_SESSION['ten'];?>"/>
       <?php if ($error_ten) { ?>
        <span class="error"><?php echo $error_ten; ?></span>
        <?php } ?>
       </td></tr>
        
        <tr><td><?php echo $dien_thoai; ?></td><td><input size="30" type="text" name="dien_thoai" value="<?php echo $_SESSION['dt'];?>"/>
        <?php if ($error_dt) { ?>
        <span class="error"><?php echo $error_dt; ?></span>
        <?php } ?>
       </td></tr>
        <tr><td><?php echo $email; ?></td><td><input size="50" type="text" name="email" value="<?php echo $_SESSION['email'];?>"/>
       </td></tr>
        <tr><td><?php echo $ten_hang; ?></td><td><input size="50" type="text" name="ten_hang" value="<?php echo $_SESSION['tenhang'];?>"/>
       </td></tr>
        <tr><td><?php echo $so_luong; ?></td><td><input type="text" name="so_luong" value="<?php echo $_SESSION['soluong'];?>"/>
       </td></tr>
        <tr><td><?php echo $thu_tu; ?></td><td><input type="text" name="thu_tu" value="<?php echo $_SESSION['thutu'];?>"/>
       </td></tr>

        <tr><td><?php echo $dia_chi; ?></td><td><textarea type="text" rows="5" cols="50" name="dia_chi"><?php echo $_SESSION['diachi'];?></textarea>
         </td></tr>
	 <tr>
	 <td></td>
	 <td></td>
