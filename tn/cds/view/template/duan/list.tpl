...
<?php include('view/template/common/left.tpl'); ?>
  ...
  <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <h1 style="font-size: 20px; font-family: Roboto Condensed">
        Danh Sách Dự Án Khởi Nghiệp
    </h1>
    <ol class="breadcrumb">
        <li><a href="index.php?module=home">Trang Chủ</a></li>
        <li class="active">Dự Án Khởi Nghiệp</li>
    </ol>
...
<td style="text-align: center;">
              ...
              <input type="checkbox" name="selected[]" value="<?php echo $duan['id_duan']; ?>" />
...
<td class="text-center" style="width: 2%;">  <?php $i = $i+1; ?>
							...
							<td style="width: 6%"> <a href ="<?php echo $duan['hinh_anh']; ?>"class="thickbox" rel="shadowbox" title="<?php echo $duan['tieu_de']?>"> 
<?php if($duan['hinh_anh']){?>           
		   <img src ="<?php echo $duan['hinh_anh'];?>"  width="80" height ="80"/>
		   	 <?php } else{?>
...
<td style="width: 30%">  <?php echo $duan['tieu_de']; ?></td>



 <td class="text-center" style="white: 10%">
           <?php echo date_format(date_create($duan['time']),'H:i:s | d/m/Y');?>
                </td>
           ...
           <?php echo $duan['stt']; ?>
				 ...
				 <td class="text-center" style="width: 15%;">
                         ...
                         [ <a href="index.php?module=duan&act=<?php echo "edit";?>&id=<?php echo $duan['id_duan']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=duan&act=del&id=<?=$duan['id_duan']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
