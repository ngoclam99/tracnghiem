      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="left">
              ...
              <a href="<?php echo $sort_order; ?>"><?php echo "Thuộc danh mục"; ?></a>
              </td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $danhmuc['tieu_de1']; ?></td>
            <td class="left"><?php echo $danhmuc['title']; ?></td>
            <td class="left"><?php echo $danhmuc['thu_tu']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=dmnho&act=<?php echo "edit";?>&id=<?php echo $danhmuc['dm_nho_id']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=dmnho&act=del&id=<?=$danhmuc['dm_nho_id']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
