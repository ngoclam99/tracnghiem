                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="tieu_de1" value="<?php echo $dmnews['tieu_de1']; ?>" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <input name="thu_tu" value="<?php echo $dmnews['thu_tu']; ?>" class="form-control" type="text">
                        </div>
				</div>	
