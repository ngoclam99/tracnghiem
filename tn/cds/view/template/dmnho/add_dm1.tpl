...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       <tr><td><?php echo $ten_loai; ?></td><td><input size="60" type="text" name="tieu_de1" value="<?php echo $_SESSION['dm'];?>"/>
        <?php if ($error_dm) { ?>
       ...
       <tr><td><?php echo $thu_tu; ?></td><td><input type="text" name="thu_tu" value="<?php echo $_SESSION['tt'];?>"/></td></tr>
