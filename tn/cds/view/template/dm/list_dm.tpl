...
<td>   <?php $i = $i+1; ?>
					...
					<?php  ?></td>
<td><?php echo $danhmuc['ten_danh_muc_sp']; ?></td>
<td>
<?php echo $danhmuc['thu_tu']; ?>
   ...
   <td class="text-center" style="white-space:nowrap; width: 10%;">
                         ...
                         [ <a href="index.php?module=dm&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id_danh_muc']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=dm&act=del&id=<?=$danhmuc['id_danh_muc']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
