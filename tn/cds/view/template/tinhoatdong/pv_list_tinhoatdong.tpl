        ...
        <tbody>
          ...
          <tr>
            <td style="text-align: center;"><?php if ($order['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tinhoatdong['tieu_de']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tinhoatdong['tieu_de']; ?>" />
              <?php } ?></td>
...
<?php if($tinhoatdong['kiem_duyet']=="tbt_nhan") { ?>
  ...
  <?php if($tinhoatdong['kiem_duyet']=="go_bai") { ?>
          Đã bị gỡ
           ...
           <?php if($tinhoatdong['kiem_duyet']=="chua") { ?>
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=gui_duyet&id=<?=$tinhoatdong['id_news']?>')"  ><?php echo "Gửi duyệt"; ?></a> ]
            [ <a href="index.php?module=tinhoatdong&act=<?php echo "edit";?>&id=<?php echo $tinhoatdong['id_news']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=del&id=<?=$tinhoatdong['id_news']?>')"  ><?php echo "Xóa"; ?></a>]
           <?php } ?>

          <?php if($tinhoatdong['kiem_duyet']=="gui") { ?>
     
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=huy_gui&id=<?=$tinhoatdong['id_news']?>')" title="Hủy gửi đế thay đổi hoặc sửa nội dung."><?php echo "Hủy gửi"; ?></a>]
           <?php } ?>
         ...
         <?php if($tinhoatdong['kiem_duyet']=="xuat_ban") { ?>
           [ <a href="index.php?module=tinhoatdong&act=<?php echo "tien_do";?>&id=<?php echo $tinhoatdong['id_news']; ?>"><?php echo "Đã xuất bản"; ?></a> ]
           <?php } ?>
 ...
 <?php if($tinhoatdong['kiem_duyet']=="tbt_sua") { ?>
         ...
         <?php if($tinhoatdong['kiem_duyet']=="btv_tra_ve") { ?>
                [ <a href="index.php?module=tinhoatdong&act=<?php echo "edit";?>&id=<?php echo $tinhoatdong['id_news']; ?>"><?php echo "Sửa lại"; ?></a> ]
           <?php } ?>
...
<?php if($tinhoatdong['kiem_duyet']=="tbt_nhan") { ?>
           ...
           <?php } ?>
  <?php if($tinhoatdong['kiem_duyet']=="go_bai") { ?>
         [ <a href="index.php?module=tinhoatdong&act=<?php echo "tien_do";?>&id=<?php echo $tinhoatdong['id_news']; ?>"><?php echo "Nhật ký"; ?></a> ]
           <?php } ?>
