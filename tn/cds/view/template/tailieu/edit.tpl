                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="">
                            <label>Tiêu đề <span class="style2">(*)</span></label>
							 ...
							 <input type="text" name="tieu_de" class="form-control" value="<?php echo $tailieu['tieu_de']; ?>"/>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                    <label>Chọn tập tin  <span class="style2">(*)</span></label>
                                    <a class="pull-right" style="cursor:pointer" onclick="BrowseServer();"><i class="fa fa-paperclip"></i> Chọn tập tin</a>
                                    <input id="xFilePath" name="file" class="form-control" type="text" value="<?php echo $tailieu['file']; ?>">
							 ...
							 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Dung lượng  <span class="style2">(*)</span></label>
                                  	 <input size="40" type="text" name="dung_luong" class="form-control" value="<?php echo $tailieu['dung_luong']; ?>"/>
