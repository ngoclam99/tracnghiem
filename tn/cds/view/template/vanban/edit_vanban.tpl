       ...
       <div class="box-body" id="boxBody">
	     <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten" class="form-control" type="text" value="<?php echo $vanban['ten'];?>">
                        </div>
						<!--
                        <div class="form-group">
						 ...
						 <div class="row">
						   <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="file" class="form-control" type="text" value="<?php echo $vanban['file'];?>">
                                                  </div>
												  
												  	<div class="form-group">
                            <label>Link Đính Kèm</label>
                            <input name="link" class="form-control" type="text" value="<?php echo $vanban['link'];?>" >
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="so_hieu" class="form-control" type="text" value="<?php echo $vanban['so_hieu'];?>" />
                                </div>
								 ...
								 <div class="form-group">
										...
										<div class="input-group date">
											<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
													<input id="datepicker" name="ngay_ban_hanh" value="<?php echo $vanban['ngay_ban_hanh'];?>" class="form-control pull-right" type="text"/>
											</div>
							 ...
							 <div class="col-md-6">
                                 <div class="form-group">
                                    <label>Hiệu Lục<span class="style2">(*)</span></label>
                 
                                    <input name="hieu_luc" class="form-control" type="text" value="<?php echo $vanban['hieu_luc'];?>" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nguoi_ky" class="form-control" type="text" value="<?php echo $vanban['nguoi_ky'];?>" />
                                </div>
                   ...
                   <?php if ($vanban['loai_van_ban_id'] == $loaivanban['loai_van_ban_id']) {?>
            ...
            <?php if($list_noibanhanh) {?>
                   ...
                   <?php if ($vanban['noi_ban_hanh_id'] == $noibanhanh['noi_ban_hanh_id']) {?>
