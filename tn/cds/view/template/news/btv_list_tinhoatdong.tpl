    ...
    <table class="list">
        ...
        <tbody>
          <?php foreach($list_chuyenmuc as $chuyen_muc){ ?>
               ...
               <?php $list_tinhoatdong =  getlisttinhoatdongtheohuyenmuckhactrangthai('chua',$chuyen_muc['cm_id'], 0, 100); ?>
         ...
         <?php if($tinhoatdong['kiem_duyet']=="tbt_tra_ve") { ?>
           ...
           <?php if($tinhoatdong['kiem_duyet']=="btv_gui") { ?>
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=btv_huy_gui_duyet&id=<?=$tinhoatdong['tin_hoat_dong_id']?>')"  ><?php echo "Hủy gửi duyệt"; ?></a> ]
           <?php } ?>
