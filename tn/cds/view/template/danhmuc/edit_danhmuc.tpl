                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten_danh_muc" class="form-control" type="text" value="<?php echo $danhmuc['ten_danh_muc'];?>"/>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input name="sap_xep" class="form-control" type="text" value="<?php echo $danhmuc['sap_xep'];?>"/>
                        </div>
						 ...
						 <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Trạng Thái Hiện Thị <span class="style2">(*)</span></label>
						...
						<option value="0" selected="selected"><?php echo "Không Hiện Thị"; ?></option>
						<?php } else { ?>
						<option value="0"><?php echo "Không Hiện Thị"; ?></option>
						<?php } ?>
						
						<?php if($danhmuc[trang_thai]==1) { ?>
						<option value="1" selected="selected"><?php echo "Hiện Thị"; ?></option> 
<?php } else { ?>
<option value="1"><?php echo "Hiện Thị"; ?></option>     						
  <?php } ?>      
