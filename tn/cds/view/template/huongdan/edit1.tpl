  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       ...
       <tr><td><?php echo $tieu_de; ?>:</td><td><input size="70" type="text" name="tieu_de" value="<?php echo $thongbao['tieu_de']; ?>"/></td></tr>
       
        <tr><td><?php echo "Thời gian"; ?></td><td><input size="70" type="text" name="thoi_gian" value="<?php echo $thongbao['thoi_gian']; ?>"/></td></tr>
       <tr><td><?php echo $noi_dung; ?></td><td><textarea type="text" name="noi_dung" id="noidung"><?php echo $thongbao['noi_dung'];?></textarea></td></tr>
        <tr>
			<td><?php echo "File đính kém";?></td>
			<td>
             <input id="xFilePath" name="file" type="text" size="60" value="<?php echo $thongbao['file'];?>" />
		    <input type="button" value="Chọn file đính kèm" onclick="BrowseServer();" /> <br/> 
            </td>
		</tr>
	  <tr><td><?php echo "Link đính kèm"; ?></td><td><input size="70" type="text" name="link" value="<?php echo $thongbao['link']; ?>"/></td></tr>
     <tr>
	 <td></td>
	 <td></td>
	 </tr>
