  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       ...
       <tr><td><?php echo $tieu_de; ?>:</td><td><input size="70" type="text" name="tieu_de" value="<?php echo $tuyendung['tieu_de']; ?>"/></td></tr>
       <tr>
			<td><?php echo $hinh_anh;?></td>
			<td>
             <input id="xFilePath" name="hinh_anh" type="text" size="70" value="<?php echo $tuyendung['hinh_anh']; ?>" />
		    <input type="button" value="Chọn ảnh" onclick="BrowseServer();" /> <br/> 
            </td>
		</tr>
       <tr><td><?php echo $mo_ta; ?></td><td><textarea type="text" name="mo_ta" id="motachung"><?php echo $tuyendung['mo_ta'];?></textarea></td></tr>
       <tr><td><?php echo $noi_dung; ?></td><td><textarea type="text" name="noi_dung" id="chitiet"><?php echo $tuyendung['noi_dung'];?></textarea></td></tr>
