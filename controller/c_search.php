...
$page = $_GET['act'];
   switch($page){
    ...
    {
    $list_timnews = getListtimkiemnews($_POST['tieu_de'],$start,$limit);
    $total = totaltimkiemnews($_POST['tieu_de']);
    //het tim kiem trong list
        ...
        $paging->total = $total;
        $paging->limit = $limit;
        $paging->url = "index.php?module=search&act=list&page={page}";
        $paging->page = $page;
		...
		require('view/theme/default/template/search.tpl');
