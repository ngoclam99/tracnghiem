...
$page = $_GET['act'];
 switch($page){
    case 'list':
    //Get language
    require('language/tailieu/list.php');
...
$link_add ='index.php?module=tailieu&act=add';  
...
if($_SESSION['phan_quyen']=='2'){
    ...
    header('LOCATION: '.$link_list);
        ...
        $list_tailieu = getListtailieu1($start, $limit);
    ...
    require('view/template/tailieu/list.tpl');  
    break;
    
    //case them can bo
    case 'add':
    require ('language/tailieu/add.php');
     ...
     $thoi_gian = thoi_gian;
         ...
         $link_list = 'index.php?module=tailieu&act=list';
    ...
    require('view/template/tailieu/add.tpl');
    break;
    //case edit gioi thieu
    case 'edit':
    require('language/tailieu/edit.php');
    $heading_title = heading_title;
    $tieu_de = tieu_de;
    $hinh_anh = hinh_anh;
    $mo_ta = mo_ta;
   ...
   if($_SERVER['REQUEST_METHOD']=='POST')
    ...
    require('view/template/tailieu/edit.tpl');
    break; 
    
    case 'del':
    get_file('language/tailieu/del.php');
    $link_list = 'index.php?module=tailieu&act=list';
