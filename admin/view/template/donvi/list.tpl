    ...
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <tbody>
          ...
          <?php if ($list_donvi) { ?>
          <?php foreach ($list_donvi as $chude) { ?>
          <tr>
            ...
            <td class="left"><?php echo $chude['ten_don_vi']; ?></td>
            <td class="left"><?php echo $chude['thu_tu']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=donvi&act=<?php echo "edit";?>&id=<?php echo $chude['id_donvi']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=donvi&act=del&id=<?=$chude['id_donvi']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
