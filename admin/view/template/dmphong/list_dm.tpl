...
<tr>
 <td style="text-align: center;"><?php if ($order['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $danhmuc['id']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $danhmuc['id']; ?>" />
              <?php } ?></td>
<td><?php echo $danhmuc['tieu_de']; ?></td>
<td>
<?php echo $danhmuc['stt']; ?>

</td>

   <td class="text-center" style="white-space:nowrap; width: 10%;">
   
                         [ <a href="index.php?module=dmphong&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=dmphong&act=del&id=<?=$danhmuc['id']; ?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
