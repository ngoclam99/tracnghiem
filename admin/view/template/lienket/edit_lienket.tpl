                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            ...
                            <input name="tieu_de" class="form-control" type="text" value="<?php echo $lienket['tieu_de'];?>">
                        </div>				                                                   					
						...
						<div class="col-md-8">
						 <div class="form-group" style="width: 100%;">
                            ...
                            <input name="link" class="form-control" type="text" value="<?php echo $lienket['link'];?>">
                        </div>
						</div>
						</div>
