					...
					<div class="row">
					 <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ho_ten" class="form-control" type="text">
							 <?php if ($error_tieude) { ?>
        ...
        <?php } ?>
						 ...
						 <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="stt" class="form-control" type="text" value="" />
                                </div>
						 ...
						 <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="chuc_vu" class="form-control" type="text" value="" />
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="dien_thoai" class="form-control" type="text" value="" />
                                </div>
