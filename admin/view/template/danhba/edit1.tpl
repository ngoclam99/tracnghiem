...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
       <table class="form">
       <tr><td><?php echo $tieu_de; ?></td><td><input size="70" type="text" name="ho_ten" value="<?php echo $danhba['ho_ten'];?>"/>
  ...
  <tr><td><?php echo "STT"; ?></td><td><input size="30" type="text" name="stt" value="<?php echo $danhba['stt'];?>"/></td></tr>
    <tr><td><?php echo "Chức vụ"; ?></td><td><input size="70" type="text" name="chuc_vu" value="<?php echo $danhba['chuc_vu'];?>"/></td></tr>
     <tr><td><?php echo "Điện thoại"; ?></td><td><input size="50" type="text" name="dien_thoai" value="<?php echo $danhba['dien_thoai'];?>"/></td></tr>
      <tr><td><?php echo "Email"; ?></td><td><input size="50" type="text" name="email" value="<?php echo $danhba['email'];?>"/></td></tr>
