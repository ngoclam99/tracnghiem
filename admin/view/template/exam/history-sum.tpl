                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <form method="post">
                                        ...
                                        <div class="form-group col-md-3 col-lg-4">
                                            <button type="button" id="xuatexcel" class="btn btn-primary" style="margin-top: 24px;" value="1" name="xuatexcel">Xuất excel</button>
                                        </div>
            ...
            if (data['tongluotthi'] > 0) {
                data['data'].map(function(val, k) {
                    html += `<tr>
                        ...
                        <td class="text-center text-nowrap fw-bold text-primary">${val['tong_lan_thi']}</td>
                        <td class="text-center text-nowrap fw-bold text-primary">${val['max_dung']} / ${val['number_of_questions']} câu - (${val['tongdiem']} điểm)</td>
                        <td class="text-center text-nowrap fw-bold text-primary">${val['forecast_candidates']} thí sinh</td>
                        <td class="text-center">${val['spent_duration']}</td>
                        ...
                        <td class="text-center"><a href="index.php?module=exam&amp;act=history-total&amp;username=${val['username']}" target="blank">Xem <i class="fa fa-eye text-info"></i></a></td>
                    </tr>`;
                });
