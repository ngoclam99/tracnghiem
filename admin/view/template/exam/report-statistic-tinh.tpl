                        ...
                        val['list'].map(function(val1, index1) {
                            if (val1['thongke'] != false) {
                                html += `<tr>
                                    ...
                                    <td  class="text-center"><span class="label label-success lb__static">${val1['thongke']['tongthisinh']} thí sinh</span></td>
                                    <td  class="text-center"><span class="label label-info lb__static">${val1['thongke']['tongluotthisinh']} lượt</span></td>
