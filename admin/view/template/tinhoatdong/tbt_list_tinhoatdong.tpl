    ...
    <table class="list">
        ...
        <tbody>
          <?php foreach($list_chuyenmuc as $chuyen_muc){ ?>
               ...
               <?php $list_tinhoatdong =  getlisttinhoatdong_tbt($chuyen_muc['id'], 0, 100); ?>
          ...
          <tr>
           ...
           <td class="left"><?php echo  $tinhoatdong['title']; ?></td>
            <td class="left" width="50"> <?php echo $tinhoatdong['tai_khoan']; ?></td>
            <td class="left" width="100"> <?php echo $tinhoatdong['tac_gia']; ?></td>
            <td class="center" width="80"><?php echo  $tinhoatdong['time']; ?></td>
            <td class="center" width="80"><?php echo  $tinhoatdong['edit_date']; ?></td>
  ...
  <?php if($tinhoatdong['kiem_duyet']=="go_bai") { ?>
          ...
          <?php if($tinhoatdong['kiem_duyet']=="btv_sua") { ?>
           ...
           <?php } ?>
            ...
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=xuat_ban&id=<?=$tinhoatdong['id_news']?>')"  ><?php echo "Xuất bản"; ?></a> ]
           ...
           <?php if($tinhoatdong['kiem_duyet']=="btv_gui") { ?>
            [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=nhan_kiem_duyet&id=<?=$tinhoatdong['id_news']?>')"  ><?php echo "Nhận duyệt"; ?></a> ]
           <?php } ?>
          ...
          <?php if($tinhoatdong['kiem_duyet']=="gui") { ?>
           ...
           <?php if($tinhoatdong['kiem_duyet']=="xuat_ban") { ?>
          Đã xuất bản  [ <a href="javascript:confirmDelete('index.php?module=tinhoatdong&act=go_bai&id=<?=$tinhoatdong['id_news']?>')" title="Nhận kiểm duyệt"><?php echo "Gỡ bài"; ?></a>]
           <?php } ?>
