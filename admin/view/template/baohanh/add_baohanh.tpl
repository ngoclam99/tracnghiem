      ...
      <table class="form">
       <tr><td><?php echo $tieu_de; ?></td><td><input size="70" type="text" name="tieu_de" value=""/></td></tr>
        <tr>
			...
			<td>
             <input id="xFilePath" name="hinh_anh" type="text" size="70" value="<?php echo $tintuc['hinh_anh']; ?>" />
		    <input type="button" value="Chọn ảnh" onclick="BrowseServer();" /> <br/> 
            </td>
		</tr>
       <tr><td><?php echo $mo_ta_chung; ?></td><td><textarea name="mo_ta_chung" id="motachung"></textarea></td></tr>
       <tr><td><?php echo $noi_dung; ?></td><td><textarea name="chi_tiet" id="chitiet"></textarea></td></tr>
	...
	function validate(theform)
		{
            ...
            else if(theform.hinh_anh.value=="")
			{
			alert("Vui lòng nhập tên người gửi");
			theform.hinh_anh.focus();
			return false;
			}  
			...
			return false;
             ...
             else if(theform.dien_thoai.value=="")
			{
			alert("Vui lòng nhập số điện thoại");
			theform.dien_thoai.focus();
			return false;
			}  
