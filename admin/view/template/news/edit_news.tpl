                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="tieu_de" class="form-control" type="text" value="<?php echo $news['tieu_de']; ?>">
                        </div>
              ...
              <?php }} ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $news['hinh_anh']; ?>">
                                                  </div>
                        ...
                        <textarea class="form-control" name="mo_ta" cols="140" rows="6" /><?php echo $news['mo_ta'];?></textarea>
						</div>                                       					
...
Tin chạy
 ...
 <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="tac_gia" class="form-control" type="text" value="<?php echo $news['tac_gia'];?>" />
                        </div>
				</div>	
				 ...
				 <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="nguon_tin" class="form-control" type="text" value="<?php echo $news['nguon_tin'];?>" />
                        </div>
				</div>	
 ...
 <div class="form-group">
                                    ...
                                    <input id="xFilePath1" name="file" class="form-control" type="text" value="<?php echo $news['file'];?>" />
                                                  </div>		
						
							  <div class="form-group">
                            <label><?php echo "Từ khóa"; ?></label>
                            <input name="tag" class="form-control" type="text" value="<?php echo $news['tag'];?>" />
                        </div>
