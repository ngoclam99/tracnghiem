                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten_loai_van_ban" class="form-control" type="text" value="<?php echo $loaivanban['ten_loai_van_ban']; ?>"/>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input name="sap_xep" class="form-control" type="text" value="<?php echo $loaivanban['sap_xep'];?>"/>
                        </div>
