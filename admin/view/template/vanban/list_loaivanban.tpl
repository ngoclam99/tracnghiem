...
<th style="width: 100px">Thao Tác</th>
   ...
   <?php if ($list_loaivanban) { ?>
          <?php foreach ($list_loaivanban as $danhmuc) { ?>
<tr>
    <td style="text-align: center;"><?php if ($order['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $danhmuc['loai_van_ban_id']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $danhmuc['loai_van_ban_id']; ?>" />
              <?php } ?></td>
<td><?php echo $danhmuc['ten_loai_van_ban']; ?></td>
<td>
<?php echo $danhmuc['sap_xep']; ?>
   ...
   <td class="text-center" style="white-space:nowrap; width: 10%;">
                         ...
                         [ <a href="index.php?module=vanban&act=<?php echo "edit_loaivanban";?>&id=<?php echo $danhmuc['loai_van_ban_id']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=vanban&act=<?php echo "del_loaivanban";?>&id=<?php echo $danhmuc['loai_van_ban_id']; ?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
