                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên File <span class="style2">(*)</span></label>
							 ...
							 <input size="70" type="text" name="tieu_de" class="form-control" value="<?php echo $download['tieu_de']; ?>"/>
						...
						<!--
						 <div class="form-group" style="width: 50%;">
                            <label>Tên tập tin <span class="style2">(*)</span></label>
							 ...
							 <input size="50" type="text" name="ten_tap_tin" class="form-control" value="<?php echo $download['ten_tap_tin']; ?>"/>
 ...
 <div class="row">
							<!--	 <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="loai_tep_tin" class="form-control" type="text" value="<?php echo $download['loai_tep_tin']; ?>" />
							 ...
							 <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="dung_luong" class="form-control" type="text" value="<?php echo $download['dung_luong']; ?>" />
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $download['hinh_anh']; ?>">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input id="xFilePath1" name="file" value="<?php echo $download['file']; ?>" class="form-control" type="text">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea name="noi_dung" id="test1" <?php echo $download['noi_dung']; ?> rows="10" cols="80">
