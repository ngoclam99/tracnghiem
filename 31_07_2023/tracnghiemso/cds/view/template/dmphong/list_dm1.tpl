      ...
      <table class="list">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $danhmuc['stt']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=dmphong&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=dmphong&act=del&id=<?=$danhmuc['id']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
