...
<div class="well">
        ...
        <div class="row">
         ...
         <div class="col-xs-12 col-md-2">
                ...
                </div>  <a class="btn btn-primary" onclick="$('#form2').attr('action', '<?php echo $delete; ?>'); $('#form2').attr('target', '_self'); $('#form2').submit();" class="button"><span><?php echo "Xuất word"; ?></span></a>
				</div>
       ...
       <?php if ($list_cts) { ?>
          <?php foreach ($list_cts as $cts) { ?>  
            <tr>
			   ...
			   <td><input type = "checkbox" value ="<?php echo $cts['id_cts'];?>"name="selected[]" /></td>
...
<span class="badge bg-red ng-scope">Đang chờ xử lý</span>

		 <?php } else 
			   if($cts['tinh_trang']=='1') { ?>
				<span class="badge bg-yellow ng-scope">Hoạt động</span>
		   <?php } ?>				
</td>
