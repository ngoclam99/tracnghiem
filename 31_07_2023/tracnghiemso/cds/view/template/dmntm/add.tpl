                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten_dm" value="<?php echo $_SESSION['dm'];?>" class="form-control" type="text">
							 <?php if ($error_dm1) { ?>
            <span class="error"><?php echo $error_dm1; ?></span>
        <?php } ?> 
                        </div>
						
						  <div class="form-group">
                            <label>Tiêu Đề <span class="style2">(*)</span></label>
                            <input name="ten" value="" class="form-control" type="text">
