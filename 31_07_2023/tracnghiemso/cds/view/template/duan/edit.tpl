...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list"><?php echo $duan['tieu_de']; ?></a></li>
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên Tiêu Đề <span class="style2">(*)</span></label>
							 ...
							 <input size="70" type="text" name="tieu_de" class="form-control" value="<?php echo $duan['tieu_de']; ?>"/>
  ...
  <div class="row">
   <div class="col-md-6">
							 ...
							 <div class="form-group">
                                    <label>Giá Dịch Vụ<span class="style2">(*)</span></label>
                 
                                    <input name="gia" class="form-control" type="text" value="<?php echo $duan['gia']; ?>" />
   ...
   <div class="col-md-2">
							 ...
							 <div class="form-group">
                                    ...
                                    <input name="stt" class="form-control" type="text" value="<?php echo $duan['stt']; ?>" />
            ...
            <?php } ?>
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            ...
                            <textarea name="mo_ta" id="test" class="form-control" style="height:70px; max-height:137px; max-width:100%"><?php echo $duan['mo_ta']; ?></textarea>
                        </div>   
