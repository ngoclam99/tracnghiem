...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <h1 style="font-size: 20px; font-family: Roboto Condensed">
        Thêm Mới Danh Sách Sự Kiện
    </h1>
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Thêm Mới DS Sự Kiện</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên Sự Kiên <span class="style2">(*)</span></label>
                        ...
                        <div class="row">
						 ...
						 <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="time" class="form-control" id="datepicker1" type="text" value="" />
                                </div>
                        ...
                        <div class="form-group">
						  ...
						  <div class="form-group">
                            ...
                            <textarea name="mo_ta" class="form-control" style="height:70px; max-height:137px; max-width:100%"></textarea>
                        </div>    
