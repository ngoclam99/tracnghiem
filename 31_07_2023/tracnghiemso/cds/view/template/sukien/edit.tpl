...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Thêm bài viết</a></li>
        <li class="active">Sủa bài</li>
    </ol>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên Sự Kiện <span class="style2">(*)</span></label>

							 <input size="70" type="text" name="tieu_de" class="form-control" value="<?php echo $sukien['tieu_de']; ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" <?php echo $sukien['hinh_anh']; ?>>
						 ...
						 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Thời gian tổ chức sự kiện</label>
                 
                                    <input name="time" class="form-control" id="datepicker1" type="text" value="<?php echo $sukien['time']; ?>" />
                                </div>
                        ...
                        <div class="form-group">
						  ...
						  <div class="form-group">
                            ...
                            <textarea name="mo_ta" class="form-control" <?php echo $sukien['mo_ta']; ?> style="height:70px; max-height:137px; max-width:100%"></textarea>
                        </div>    
				
                         <div class="form-group">
                            <label><?php echo $noi_dung; ?></label>
                            <textarea name="noi_dung" id="test1" <?php echo $sukien['noi_dung']; ?> rows="10" cols="80">
