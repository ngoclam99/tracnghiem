  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
      <table class="form">
       ...
       <tr><td><?php echo $ma_san_pham; ?></td><td><input size="40" type="text" name="ma_san_pham" value="<?php echo $maytinh['ma_san_pham']; ?>"/>
...
<?php } ?>
       ...
       <tr><td><?php echo $ten_san_pham; ?></td><td><input size="60" type="text" name="ten_san_pham" value="<?php echo $maytinh['ten_san_pham'];?>" />
...
<?php } ?> 
      ...
      <tr>
			...
			<td>
             <input id="xFilePath" name="hinh_anh" type="text" size="60" value="<?php echo $maytinh['hinh_anh']; ?>" />
		    <input type="button" value="Chọn ảnh" onclick="BrowseServer();" /> <br/> 
            </td>
		</tr>
        
       <tr><td><?php echo $gia_san_pham; ?></td><td><input size="20" type="text" name="gia_san_pham" value="<?php echo $maytinh['gia_san_pham'];?>"/><td><?php echo $bao_hanh; ?></td><td><input size="20" type="text" name="bao_hanh" value="<?php echo $maytinh['bao_hanh'];?>"/></td>
          

       </td> </tr>
       <tr><td><?php echo $hang_san_xuat; ?></td><td><input size="30" type="text" name="hang_san_xuat" value="<?php echo $maytinh['hang_san_xuat'];?>"/></td></tr>
       <tr><td><?php echo $khuyen_mai; ?></td><td><input size="40" type="text" name="khuyen_mai" value="<?php echo $maytinh['khuyen_mai'];?>"/>
...
<?php } ?> 
        ...
        <tr>
          ...
          <td><select name="kho_hang"><?php echo $maytinh['kho_hang'];?>
          ...
          <tr><td><?php echo $mo_ta; ?></td><td><textarea type="text" name="mo_ta" id="motachung"><?php echo $maytinh['mo_ta'] ;?></textarea></td></tr>
          <tr><td><?php echo $noi_dung; ?></td><td><textarea type="text" name="noi_dung" id="chitiet"><?php echo $maytinh['noi_dung'] ;?></textarea></td></tr>
