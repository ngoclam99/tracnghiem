...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       <tr><td><?php echo $ten_loai; ?></td><td><input size="70" type="text" name="ten_chu_de" value="<?php echo $_SESSION['ten'];?>"/>
        <?php if ($error_chude) { ?>
       ...
       <tr><td><?php echo $thu_tu; ?></td><td><input size="40" type="text" name="thu_tu" value="<?php echo $_SESSION['thutu'];?>"/></td></tr>
