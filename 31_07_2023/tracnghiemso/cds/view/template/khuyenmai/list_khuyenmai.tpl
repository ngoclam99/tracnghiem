    ...
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <tbody>
          ...
          <?php if ($list_khuyenmai) { ?>
          <?php foreach ($list_khuyenmai as $khuyenmai) { ?>
          <tr>
            ...
            <td class="left"><?php echo $khuyenmai['tieu_de']; ?></td>
            <td class="left"><?php echo $khuyenmai['thoi_gian']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=khuyenmai&act=<?php echo "edit";?>&id=<?php echo $khuyenmai['ma_khuyen_mai']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=khuyenmai&act=del&id=<?=$khuyenmai['ma_khuyen_mai']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
