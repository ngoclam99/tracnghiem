  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       ...
       <tr><td><?php echo $ten_loai; ?>:</td><td><input size="70" type="text" name="ten_don_vi" value="<?php echo $donvi['tieu_de']; ?>"/></td></tr>
       
      <tr><td><?php echo $thu_tu; ?>:</td><td><input size="40" type="text" name="thu_tu" value="<?php echo $donvi['thu_tu']; ?>"/></td></tr>
