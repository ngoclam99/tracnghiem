    ...
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <tbody>
          ...
          <?php if ($list_linhvuc) { ?>
          <?php foreach ($list_linhvuc as $danhmuc) { ?>
          <tr>
            ...
            <td class="left"><?php echo $danhmuc['ten_linh_vuc']; ?></td>
            <td class="left"><?php echo $danhmuc['thu_tu']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=linhvuc&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id_dmlinhvuc']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=linhvuc&act=del&id=<?=$danhmuc['id_dmlinhvuc']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
