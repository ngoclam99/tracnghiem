                    ...
                    <div class="box-body">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" style="margin-top:5px">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" id="txtSearch"
                                        placeholder="Từ khóa tìm kiếm đơn vị công tác" />
                        ...
                        <div class="panel panel-success" style="margin-top:5px">
                            <div class="panel-body">
                                <div id="result" class="table-responsive" style="height:370px; overflow-y:scroll;">
...
<script src = 'assets/js/customize/workplace/js_workplace.js'></script>
