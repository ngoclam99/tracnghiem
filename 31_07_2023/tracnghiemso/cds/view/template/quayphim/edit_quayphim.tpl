...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Sửa Video - Clip</a></li>
        <li class="active">Sửa Video - Clip</li>
    </ol>
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên Tiêu Đề</label>
							 ...
							 <input size="70" type="text" name="tieu_de" class="form-control" value="<?php echo $quayphim['tieu_de']; ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $quayphim['hinh_anh']; ?>">
							 ...
							 <div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input id="xFilePath1" name="file" class="form-control" type="text" value="<?php echo $quayphim['file']; ?>">
						...
						<div class="col-md-8">
						 <div class="form-group" style="width: 100%;">
                            ...
                            <input name="video" class="form-control" type="text" value="<?php echo $quayphim['video']; ?>">
                        </div>
						</div>
						</div>
...
<div class="checkbox">
<label>
  <?php if($quayphim['noi_bat']=='1'){ ?>    
<input type="checkbox" name="noi_bat" value="1" checked/>Video Nổi Bật</label>
 <?php } else { ?>
 <input type="checkbox" name="noi_bat" value="1">Video Nổi Bật</label>
  <?php } ?> 
</div>
