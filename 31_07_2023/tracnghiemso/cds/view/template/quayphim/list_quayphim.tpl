...
<td style="width: 6%"> <a href ="<?php echo $quayphim['hinh_anh']; ?>"class="thickbox" rel="shadowbox" title="<?php echo $quayphim['tieu_de']?>"> 
            <img src ="<?php echo $quayphim['hinh_anh'];?>" class="bimg" width="80" height ="80"/>
            </a> </td>
<td style="width: 30%">  <?php echo $quayphim['tieu_de']; ?></td>
<td class="text-center" style="width: 10%;">   <?php if($quayphim['noi_bat']=='0') {echo "Video" ;}
            else if($quayphim['noi_bat']=='1'){echo "Video nổi bật" ;}
         ?> </td>

<td class="text-center" style="width: 13%;"><?php echo $quayphim['luot_xem']; ?> </td>


 <td class="text-center" style="white-space:nowrap">
           <?php echo date_format(date_create($quayphim['time']),'H:i:s | d-m-Y');?>
                </td>
			
				 <td class="text-center" style="white-space:nowrap; width: 10%;">
                         [ <a href="index.php?module=media&act=<?php echo "edit";?>&id=<?php echo $quayphim['ma_quay_phim']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=media&act=del&id=<?=$quayphim['ma_quay_phim']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
