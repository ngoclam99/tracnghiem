                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten_dm" class="form-control" type="text" value="<?php echo $dmtieuchi['ten_dm'];?>"/>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input name="thu_tu" class="form-control" type="text" value="<?php echo $dmtieuchi['thu_tu'];?>"/>
                        </div>
