    ...
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <tbody>
          ...
          <?php if ($list_dmdownload) { ?>
          <?php foreach ($list_dmdownload as $danhmuc) { ?>
          <tr>
            ...
            <td class="left"><?php echo $danhmuc['ten_dm']; ?></td>
            <td class="left"><?php echo $danhmuc['thu_tu']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=dmdownload&act=<?php echo "edit";?>&id=<?php echo $danhmuc['id_dmdownload']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=dmdownload&act=del&id=<?=$danhmuc['id_dmdownload']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
