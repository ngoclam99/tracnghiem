...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Hướng dẫn</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Tập Tin  <span class="style2">(*)</span></label>
                                    <a class="pull-right" style="cursor:pointer" onclick="BrowseServer();"><i class="fa fa-paperclip"></i> Chọn tập tin</a>
                                    <input id="xFilePath" name="file" class="form-control" type="text" value="">
					 ...
					 <div class="col-md-6">
                                <div class="form-group">
                                    <label>Dung lượng  <span class="style2">(*)</span></label>
                                  	 <input size="40" type="text" name="dung_luong" class="form-control" value=""/>
