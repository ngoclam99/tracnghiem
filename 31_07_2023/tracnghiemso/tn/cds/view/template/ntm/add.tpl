...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <h1 style="font-size: 20px; font-family: Roboto Condensed">
        Thêm danh sách xã NTM
    </h1>
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Nông Thôn Mới</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="bao_cao" class="form-control" type="text" value="">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input id="xFilePath1" name="quyet_dinh" class="form-control" type="text">
 ...
 <!--
							  ...
							  <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath2" name="de_an" class="form-control" type="text" value="">
