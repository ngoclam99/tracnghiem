       ...
       <div class="box-body" id="boxBody">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="ten_danh_muc_sp" value="<?php echo $_SESSION['dm'];?>" class="form-control" type="text">
							 <?php if ($error_dm1) { ?>
        ...
        <?php } ?> 
                        ...
                        <div class="form-group">
                            ...
                            <input name="thu_thu" value="<?php echo $_SESSION['tt'];?>" class="form-control" type="text">
                        </div>
				</div>	
