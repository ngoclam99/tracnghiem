                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="">
                            <label>Tiêu đề <span class="style2">(*)</span></label>
							 ...
							 <input type="text" name="tieu_de" class="form-control" value="<?php echo $khuyenhoc['tieu_de']; ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="file" class="form-control" type="text" value="<?php echo $khuyenhoc['file']; ?>">
