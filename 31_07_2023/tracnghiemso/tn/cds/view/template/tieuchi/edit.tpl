       ...
       <div class="box-body" id="boxBody">
	     <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="tieu_de" class="form-control" type="text" value="<?php echo $tieuchi['tieu_de'];?>">
            ...
            <?php if($list_dm) {?>
                   ...
                   <?php if ($dm['id_dmtieuchi'] == $tieuchi['dmtieuchi_id']) {?>
                   ...
                   <?php }?>
						   ...
						   <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="files" class="form-control" type="text" value="<?php echo $tieuchi['files'];?>">
                                                  </div>
                        ...
                        <div class="form-group">
                            <label>Mô Tả</label>
                            <textarea name="mo_ta" class="form-control" style="height:70px; max-height:137px; max-width:100%"/><?php echo $tieuchi['mo_ta'];?></textarea>
                        </div>
                    ...
                    <!--
                            ...
                            <input name="tu_khoa" class="form-control" type="text" value="<?php echo $tieuchi['tukhoa'];?>" />
                        </div>-->
