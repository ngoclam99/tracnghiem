...
<strong style="color:red">*</strong>
       ...
       <div class="box-body" id="boxBody">
	     <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            ...
                            <input name="tieu_de" class="form-control" type="text" value="<?php echo $adv['tieu_de']; ?>">
                        </div>				                                                   					
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $adv['hinh_anh']; ?>">
                                                  </div>
						...
						<div class="col-md-8">
						 <div class="form-group" style="width: 100%;">
                            ...
                            <input name="link" class="form-control" type="text" value="<?php echo $adv['link']; ?>">
                        </div>
						</div>
						</div>
              ...
              <option value="3" selected="selected"><?php echo "Quảng Cáo Phải Trên"; ?></option> 
              <?php } else { ?>
              <option value="3"><?php echo "Quảng Cáo Phải Trên"; ?></option>  
              <?php } ?> 
              
                <?php if($adv['lua_chon_id']=='4') { ?>
              <option value="4" selected="selected"><?php echo "Quảng Cáo Phải Dưới"; ?></option> 
              <?php } else { ?>
              <option value="4"><?php echo "Quảng Cáo Phải Dưới"; ?></option>  
              <?php } ?> 
              
               <?php if($adv['lua_chon_id']=='5') { ?>
              <option value="5" selected="selected"><?php echo "Trung tâm cuối trang"; ?></option> 
              <?php } else { ?>
