                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input name="tieu_de" class="form-control" type="text" value="<?php echo $sanpham['tieu_de'];?>">
                        </div>
						<!--
                        <div class="form-group">
						 ...
						 <div class="row">
						   <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $sanpham['hinh_anh'];?>">
                                                  </div>
   ...
   <div class="row">
							  ...
							  <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="ho_ten" class="form-control" type="text" value="<?php echo $sanpham['ho_ten'];?>" />
                                </div>
			...
			<option>----------<?php echo "Lựa chọn"; ?>----------</option>
              ...
              <option value="1" selected="selected"><?php echo "1 sao"; ?></option>
			  <?php } else { ?>
			  <option value="1"><?php echo "1 sao"; ?></option>
			  <?php } ?>
			  <?php if($sanpham['xep_hang']=='2') { ?>
              <option value="2" selected="selected"><?php echo "2 sao"; ?></option>
			  <?php } else { ?>
			  <option value="2" selected="selected"><?php echo "2 sao"; ?></option>
			  <?php } ?>
			  <?php if($sanpham['xep_hang']=='3') { ?>
              <option value="3" selected="selected"><?php echo "3 sao"; ?></option>
			  <?php } else { ?>
			  <option value="3"><?php echo "3 sao"; ?></option>
			  <?php } ?>
			  <?php if($sanpham['xep_hang']=='4') { ?>
              <option value="4" selected="selected"><?php echo "4 sao"; ?></option>
			  <?php } else { ?>
			  <option value="4"><?php echo "4 sao"; ?></option>
			  <?php } ?>
			  <?php if($sanpham['xep_hang']=='5') { ?>
              <option value="5" selected="selected"><?php echo "5 sao"; ?></option>
			  <?php } else { ?>
                            ...
                            <div class="col-md-6">
							  ...
							  <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="don_vi" class="form-control" type="text" value="<?php echo $sanpham['don_vi'];?>" />
                                </div>
            ...
            <?php if($list_dm) {?>
                   ...
                   <?php if ($dm['id_danh_muc'] == $sanpham['muc_id']) {?>
                    <option value="<?php echo $dm['id_danh_muc']; ?>" selected="selected"> <?php echo $dm['ten_danh_muc_sp']; ?>  </option>
                   <?php } else {?>
                   ...
                   <?php }?>
                        ...
                        <div class="form-group">
                            <label>Mô Tả</label>
                            <textarea name="mo_ta" id="ctl00_phContent_txtGhiChu1" class="form-control" style="height:70px; max-height:137px; max-width:100%"><?php echo $sanpham['mo_ta'];?></textarea>
                        </div>
