  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
      <table class="form">
       ...
       <tr><td><?php echo $ten_san_pham; ?></td><td><input size="60" type="text" name="tieu_de" value="<?php echo $_SESSION['tieude'];?>" />
        <?php if ($error_tieude) { ?>
      ...
      <tr>
			...
			<td>
             <input id="xFilePath" name="hinh_anh" type="text" size="60" value="<?php echo $_SESSION['hinhanh'];?>" />
		    <input type="button" value="Chọn ảnh" onclick="BrowseServer();" /> <br/> 
            </td>
		</tr>
        <tr><td><?php echo "Link Video"; ?></td><td><input size="80" type="text" name="video" value="<?php echo $_SESSION['video'];?>"/>
       <tr><td><?php echo $gia_san_pham; ?></td><td><input size="20" type="text" name="gia" value="<?php echo $_SESSION['gia'];?>"/>
          

       </td> </tr>
       <tr><td><?php echo $so_luong; ?></td><td><input size="10" type="text" name="so_luong" value="<?php echo $_SESSION['soluong'];?>"/><span style="padding-left: 20px; color:red; font-weight: bold;"> (DVD or CD) </span></td></tr>
       <tr><td><?php echo $dung_luong; ?></td><td><input size="15" type="text" name="dung_luong" value="<?php echo $_SESSION['soluong'];?>"/><span style="padding-left: 20px; color:red; font-weight: bold;">(MB - GB)</span>
       </td></tr>
        <tr><td><?php echo "Định dạng"; ?></td><td><input size="35" type="text" name="dinh_dang" value="<?php echo $_SESSION['dinhdang'];?>"/><span style="padding-left: 20px; color:red; font-weight: bold;">(PSD, AI, EPS )</span>
       </td></tr>
  
         <tr>
			<td><?php echo $anh1;?></td>
			<td>
             <input id="xFilePath1" name="anh1" type="text" size="40" value="<?php echo $_SESSION['anh1'];?>" />
          ...
          <tr>
			<td><?php echo $anh2;?></td>
			<td>
             <input id="xFilePath2" name="anh2" type="text" size="40" value="<?php echo $_SESSION['anh2'];?>" />
          ...
          <tr>
			<td><?php echo $anh3;?></td>
			<td>
             <input id="xFilePath3" name="anh3" type="text" size="40" value="<?php echo $_SESSION['anh3'];?>" />
          ...
          <tr>
			<td><?php echo $anh4;?></td>
			<td>
             <input id="xFilePath4" name="anh4" type="text" size="40" value="<?php echo $_SESSION['anh4'];?>" />
		    <input type="button" value="Chọn ảnh" onclick="BrowseServer4();" /> <br/> 
            </td>
		</tr>
  
          <tr><td><?php echo $mo_ta; ?></td><td><textarea type="text" name="noi_dung" id="noidung"><?php echo $_SESSION['noidung'];?></textarea></td></tr>
       <tr>
			<td><?php echo "Sản phẩm tiêu biểu";?></td>
			<td>
            <label>
<input type="checkbox" value="1" name="tieu_bieu">
</label> 
            </td>
		</tr>   
	 <tr>
