      ...
      <table class="list">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="left"><?php echo $info['view']; ?></td>
            <td class="left"><?php echo $info['time']; ?></td>
            <td class="right" width="80">
            [ <a href="index.php?module=info&act=<?php echo "edit";?>&id=<?php echo $info['id_info']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=info&act=del&id=<?=$info['id_info']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
