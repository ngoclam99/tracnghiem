	     ...
	     <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" onclick="return validate(this);">
          ...
          <div class="col-md-8">
                        <div class="form-group">
                            <label>Tên Danh Muc <span class="style2">(*)</span></label>
                            <input name="ten_dm" value="<?php echo $danhmuc['ten_dm'];?>" class="form-control" type="text">
							
                        </div>
						
						  <div class="form-group">
                            <label>Tiêu Đề <span class="style2">(*)</span></label>
                            <input name="ten" value="<?php echo $danhmuc['ten'];?>" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <input name="thu_tu" value="<?php echo $danhmuc['thu_tu'];?>" class="form-control" type="text">
                        </div>
				</div>	
