...
<td>   <?php $i = $i+1; ?>
					...
					<?php  ?></td>
<td><?php echo $danhmuc['tieu_de1']; ?></td>
<td><?php echo $danhmuc['title']; ?></td>
 <td class="left"><?php echo $danhmuc['thu_tu']; ?></td>

   <td class="text-center" style="white-space:nowrap; width: 10%;">
   
                         [ <a href="index.php?module=dmnho&act=<?php echo "edit";?>&id=<?php echo $danhmuc['dm_nho_id']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=dmnho&act=del&id=<?=$danhmuc['dm_nho_id']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
