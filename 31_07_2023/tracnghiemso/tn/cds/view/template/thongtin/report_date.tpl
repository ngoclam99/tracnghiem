...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <h1 style="font-size: 20px; font-family: Roboto Condensed">
      Báo cáo <?php echo $_GET['tu_ngay']; ?>   đến <?php echo $_GET['den_ngay']; ?>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-2">
                <div class="form-group">
                 ...
                 Từ ngày <input class="form-control" type="date" value="<?php echo $_SESSION['tu_ngay'];?>" maxlength="5" name="tu_ngay"   />
                </div>
            </div>
			  ...
			  <div class="col-xs-12 col-md-2">
                ...
                đến ngày    <input class="form-control" type="date" value="<?php echo $_SESSION['den_ngay'];?>" maxlength="5" name="den_ngay" />
                </div>
            </div>
