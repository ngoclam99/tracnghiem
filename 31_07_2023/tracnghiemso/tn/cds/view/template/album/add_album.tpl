                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group" style="width: 50%;">
                                        ...
                                        <input size="70" type="text" name="tieu_de" class="form-control"
                                            value="<?php echo $_SESSION['tieude']; ?>" />
                                        <?php if ($error_tieude) { ?>
                                        <span class="error">
                                            <?php echo $error_tieude; ?>
                                        </span>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <a class="pull-right" style="cursor:pointer"
                                                    onclick="BrowseServer();"><i class="fa fa-paperclip"></i> Chọn ảnh
                                                    đại diện</a>
                                                <input id="xFilePath" name="hinh_anh" class="form-control" type="text"
                                                    value="<?php echo $_SESSION['pic']; ?>">
                                                <?php if ($error_pic) { ?>
                                                <span class="error">
                                                    <?php echo $error_pic; ?>
                                                </span>
            ...
            <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ctl00$phContent$txtGhiChu1" id="ctl00_phContent_txtGhiChu1" class="form-control" style="height:70px; max-height:137px; max-width:100%"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="noi_dung" id="test1" rows="10" cols="80"><?php echo $_SESSION['noidung']; ?>
                        ...
                        <div class="box-footer text-center">
                            ...
                            <button class="btn btn-sm btn-primary btn-flat"
                                onclick="location = '<?php echo $link_list; ?>';" style="margin-top:4px">
