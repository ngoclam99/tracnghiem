...
<td style="width: 6%"> <a href ="<?php echo $tenalbum['hinh_anh']; ?>"class="thickbox" rel="shadowbox" title="<?php echo $tenalbum['tieu_de']?>"> 
            <img src ="<?php echo $tenalbum['hinh_anh'];?>" class="bimg" width="80" height ="80"/>
            </a> </td>
...
<td class="text-center" style="width: 10%;">
 ...
 <td class="text-center" style="white-space:nowrap">
           <?php echo date_format(date_create($tenalbum['thoi_gian']),'H:i:s | d-m-Y');?>
				 ...
				 [ <a href="index.php?module=media&act=<?php echo "upanh";?>&id=<?php echo $album['ma_quay_phim']; ?>" title="Thêm Ảnh"><span class="label label-primary">Xem</span></a> ]
				 [ <a href="index.php?module=media&act=<?php echo "xem,";?>&id=<?php echo $album['ma_quay_phim']; ?>" title="Xem Ảnh"><i class="fa fa-pencil-square-o"></i></a> ]
                         [ <a href="index.php?module=media&act=<?php echo "edit";?>&id=<?php echo $album['ma_quay_phim']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=media&act=del&id=<?=$album['ma_quay_phim']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
