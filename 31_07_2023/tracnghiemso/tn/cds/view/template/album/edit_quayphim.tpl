...
<?php include('view/template/common/left.tpl'); ?>
 <div class="content-wrapper" style="clear: both; min-height: 864px;" id="content">
    ...
    <ol class="breadcrumb">
        <li><a href="index.php?module=categories&act=list">Sửa Album Ảnh</a></li>
                    ...
                    <div class="col-md-8">
                        <div class="form-group" style="width: 50%;">
                            <label>Tên Tiêu Đề</label>
							 ...
							 <input size="70" type="text" name="tieu_de" class="form-control" value="<?php echo $tenalbum['tieu_de']; ?>"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="xFilePath" name="hinh_anh" class="form-control" type="text" value="<?php echo $tenalbum['hinh_anh']; ?>">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea name="noi_dung" id="test1" <?php echo $tenalbum['noi_dung'];?> rows="10" cols="80">
