    ...
    <form action="" method="post" enctype="multipart/form-data" id="form">
      <table class="list">
        ...
        <tbody>
          ...
          <?php if ($list_lct) { ?>
          <?php foreach ($list_lct as $info) { ?>
          <tr>
             <td style="text-align: center;">
              <input type="checkbox" name="selected[]" value="<?php echo $info['id_lich']; ?>" />
             </td>
            ...
            [ <a href="index.php?module=lct&act=<?php echo "edit";?>&id=<?php echo $info['id_lich']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=lct&act=del&id=<?=$info['id_lich']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
