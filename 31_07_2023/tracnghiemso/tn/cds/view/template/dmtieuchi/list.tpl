...
<th style="width: 100px">Thao Tác</th>
   ...
   <?php if ($list_dmtieuchi) { ?>
          <?php foreach ($list_dmtieuchi as $tieuchi) { ?>
<tr>
 <td style="text-align: center;"><?php if ($order['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tieuchi['id_dmtieuchi']; ?>" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $tieuchi['id_dmtieuchi']; ?>" />
              <?php } ?></td>
<td><?php echo $tieuchi['ten_dm']; ?></td>
<td>
<?php echo $tieuchi['thu_tu']; ?>
</div>
</td>

   <td class="text-center" style="white-space:nowrap; width: 10%;">
   
                         [ <a href="index.php?module=dmtieuchi&act=<?php echo "edit";?>&id=<?php echo $tieuchi['id_dmtieuchi']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
						 [ <a href="javascript:confirmDelete('index.php?module=dmtieuchi&act=del&id=<?=$tieuchi['id_dmtieuchi']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
