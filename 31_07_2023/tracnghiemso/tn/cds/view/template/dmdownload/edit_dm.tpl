  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       ...
       <tr><td><?php echo $ten_loai; ?>:</td><td><input size="70" type="text" name="ten_dm" value="<?php echo $dmdownload['ten_dm']; ?>"/></td></tr>
       
      <tr><td><?php echo $thu_tu; ?>:</td><td><input size="70" type="text" name="thu_tu" value="<?php echo $dmdownload['thu_tu']; ?>"/></td></tr>
