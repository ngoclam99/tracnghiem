      ...
      <table class="list">
        ...
        <tbody>
          ...
          <tr>
            ...
            [ <a href="index.php?module=chude&act=<?php echo "edit";?>&id=<?php echo $chude['id_chu_de']; ?>"><?php echo "Sửa"; ?></a> ]
            [ <a href="javascript:confirmDelete('index.php?module=chude&act=del&id=<?=$chude['id_chu_de']?>')"  ><?php echo "Xóa"; ?></a>]
            </td>
          </tr>
          <?php } ?>
          <?php } else { ?>
