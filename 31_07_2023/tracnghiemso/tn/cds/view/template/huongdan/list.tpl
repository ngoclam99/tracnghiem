...
<table class="table table-bordered table-striped table-hover" style="margin-bottom: 0;">
    ...
    <tbody>
           ...
           <?php if ($list_huongdan) { ?>
          <?php foreach ($list_huongdan as $huongdan) { ?>   
<tr>
<td style="text-align: center;">

              <input type="checkbox" name="selected[]" value="<?php echo $huongdan['id_huongdan']; ?>" />
...
<td style="width: 70%">  <?php echo $huongdan['tieu_de']; ?></td>




 <td class="text-center" style="white-space:nowrap">
           <?php echo date_format(date_create($huongdan['time']),'d-m-Y');?>
                </td>
			
				 <td class="text-center" style="white-space:nowrap; width: 10%;">
				 
			
                         [ <a href="index.php?module=huongdan&act=<?php echo "edit";?>&id=<?php echo $huongdan['id_huongdan']; ?>" title="Sửa bài viết"><i class="fa fa-pencil-square-o"></i></a> ]
				
						[ <a href="javascript:confirmDelete('index.php?module=huongdan&act=del&id=<?=$huongdan['id_huongdan']?>')" title="Xóa bài viết"><i class="fa fa-trash-o" style="color: red;"></i></a> ]
