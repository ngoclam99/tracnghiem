                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
						 ...
						 <div class="row">
						   <div class="col-md-6">
                            ...
                            <input name="link_anh" class="form-control" type="text" value="<?php echo $_SESSION['linkanh'];?>" >
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="kieu_file" class="form-control" type="text" value="<?php echo $_SESSION['file'];?>" />
                                </div>
                            ...
                            <div class="col-md-6">
							 ...
							 <div class="form-group">
                                    ...
                                    <input name="price" class="form-control" type="text" value="<?php echo $_SESSION['price'];?>" />
                                </div>
							 ...
							 <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input name="mb" class="form-control" type="text" value="<?php echo $_SESSION['mb'];?>" />
                                </div>
                          ...
                          <div class="form-group">
                                    ...
                                    <input id="xFilePath1" name="link_tai" class="form-control" type="text">
                                                  </div>
						
						 <div class="form-group">
                            <label><?php echo $mediafire; ?></label>
                            <input name="mediafire" class="form-control" type="text" value="<?php echo $_SESSION['mediafire'];?>" >
                        </div>
						
						 <div class="form-group">
                            <label><?php echo $fshare; ?></label>
                            <input name="fshare" class="form-control" type="text" value="<?php echo $_SESSION['fshare'];?>" >
                        </div>
						
						 <div class="form-group">
                            <label><?php echo $drive; ?></label>
                            <input name="drive" class="form-control" type="text" value="<?php echo $_SESSION['drive'];?>" >
                        </div>
						...
						<!--
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="pass" class="form-control" type="text" value="<?php echo $_SESSION['pass'];?>" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="mo_ta" id="test1" rows="10" cols="80" <?php echo $_SESSION['mota'];?>>
