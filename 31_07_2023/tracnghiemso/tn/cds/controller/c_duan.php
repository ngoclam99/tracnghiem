...
$page = $_GET['act'];
 switch($page){
    case 'list':
    //Get language
    require('language/duan/list.php');
...
$link_add ='index.php?module=duan&act=add';
    ...
    require('view/template/duan/list.tpl');  
    break;
    ...
    require ('language/duan/add.php');
     ...
     $link_list = 'index.php?module=duan&act=list';
         
    
    // $list_dmduan = getListdmduan(0,50);
    ...
    require('view/template/duan/add.tpl');
    break;
    ...
    case 'edit':
    require('language/duan/edit.php');
    $heading_title = heading_title;
    $tieu_de = tieu_de;
    $noi_dung = noi_dung;
   ...
   if($_SERVER['REQUEST_METHOD']=='POST')
    ...
    require('view/template/duan/edit.tpl');
    break; 
    
    case 'del':
    get_file('language/duan/del.php');
    $link_list = 'index.php?module=duan&act=list';
    $id = $_REQUEST['id'];
    delduan($id);
